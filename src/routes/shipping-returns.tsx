...
export const Route = createFileRoute("/shipping-returns")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Same-week GTA delivery, Canada-wide and US shipping, plus our gentle 30-day returns policy." },
      ...
      <div className="mx-auto max-w-[1000px]">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2">
          <Card icon={MapPin} title="GTA local same-week">
            Free local delivery on orders over $75 anywhere within the Greater Toronto Area. Delivered Tuesday–Friday, with a text the morning of.
          </Card>
          <Card icon={Truck} title="Canada-wide">
            Canada Post tracked shipping from $9. Free on orders over $150. Typical transit: 2–5 business days.
          </Card>
          <Card icon={Package} title="USA & international">
            We ship to the US (5–10 days) and select international destinations on request. Duties are calculated at checkout.
          </Card>
          <Card icon={RefreshCw} title="30-day returns">
            Not in love with your piece? Send it back within 30 days, in original condition, for a full refund. Personalised items are final sale (we'll send a digital proof before stitching so you're sure).
          </Card>
        </div>

        <div className="mt-16 space-y-5 text-base leading-relaxed text-muted-foreground">
          <h2 className="font-display text-3xl italic text-foreground">The fine print, kept short</h2>
          <p><strong className="text-foreground">Processing time:</strong> 5–7 business days from order approval. Rush turnaround in 48 hours is available for an additional fee — message us first.</p>
          <p><strong className="text-foreground">Holiday deadlines:</strong> Order by February 7 (Valentine's), April 24 (Mother's Day), June 5 (Father's Day), and December 5 (Christmas) for guaranteed delivery.</p>
          <p><strong className="text-foreground">Address changes:</strong> Email hello@gtathreads.com within 12 hours of ordering and we'll update before stitching begins.</p>
          <p><strong className="text-foreground">Damaged in transit:</strong> Send us a photo within 7 days of delivery and we'll replace at no charge.</p>
        </div>
...
function Card({ icon: Icon, title, children }: { icon: typeof Truck; title: string; children: React.ReactNode }) {
  return (
